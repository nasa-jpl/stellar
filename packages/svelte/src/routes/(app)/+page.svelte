...
<div class="flex flex-col gap-4 bg-background p-16">
  <div class="text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]">
    Components for powerful apps
  </div>
  <p class="text-lg font-light">
    Flexible React and Svelte components to create powerful, accessible, and easy-to-use web tools.
  </p>
  <div>
    Button
