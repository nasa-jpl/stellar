...
>
  <p class="bg-orange-400 py-1.5 text-center text-sm font-medium text-black dark:bg-orange-700 dark:text-white">
    Stellar 2.0 is in preview. Expect breaking changes until the full release is ready.
  </p>
