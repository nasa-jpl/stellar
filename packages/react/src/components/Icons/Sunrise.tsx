...
const SvgSunrise = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" viewBox="0 0 16 16" {...props}>
    ...
    <path
      fill="currentColor"
      d="M10.954 3.588a.72.72 0 0 0-.13-.726L8.424.195A.57.57 0 0 0 8 0c-.16 0-.312.07-.424.195l-2.4 2.667a.72.72 0 0 0-.13.726c.093.25.311.412.554.412h4.8a.6.6 0 0 0 .554-.412"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M8 7a1 1 0 0 0 1-1V4a1 1 0 0 0-2 0v2a1 1 0 0 0 1 1M4.5 12a3.5 3.5 0 1 1 7 0 .5.5 0 0 1-.5.5H5a.5.5 0 0 1-.5-.5"
      clipRule="evenodd"
    />
  </svg>
);
