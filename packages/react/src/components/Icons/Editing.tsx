...
const SvgEditing = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="none" viewBox="0 0 16 16" {...props}>
    <path
      fill="currentColor"
      d="M9.42 2.307a1.11 1.11 0 0 1 1.531 0c.423.424.423 1.11 0 1.533l-.575.575a.27.27 0 0 1-.383 0l-1.148-1.15a.27.27 0 0 1 0-.383zM7.753 4.071a.26.26 0 0 1 .358 0l1.076 1.077c.1.099.1.26 0 .359l-3.373 3.35a4.7 4.7 0 0 1-1.555 1.022l-.911.366a.26.26 0 0 1-.274-.056.25.25 0 0 1-.056-.274l.365-.912a4.7 4.7 0 0 1 1.022-1.556z"
    />
